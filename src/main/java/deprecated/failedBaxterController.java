...
//
//import com.shattered.baxt.CodeRepo;
//import com.shattered.baxt.Concatenate;
//import com.shattered.baxt.FileSpecRepo;
//import com.shattered.baxt.PictureWrapper;
//import com.shattered.baxt.UploadController;
//
//@SessionAttributes("fsr")
//@Controller("/baxt")
//public class failedBaxterController {
//
//	@ModelAttribute("fsr")
...
//	@RequestMapping(value = "baxt/trim-action")
//	public String moveVideoUp(Model model, Principal principal,@RequestParam("trim-action") String action, @RequestParam("file") String filename, @ModelAttribute("fsr") FileSpecRepo fsr, @RequestParam("trimStart") String trimStart, @RequestParam("trimEnd") String trimEnd, @RequestParam("filepath") String filepath, @RequestParam(value = "code", required = false) String code) throws IOException {
...
//		}
//		switch(action) {
//		case "up": fsr.moveVideoUp(fsr.getFileSpecByFileName(filename));
//		break;
//		case "down": fsr.moveVideoDown(fsr.getFileSpecByFileName(filename));
//		break;
//		case "copy": {
...
//		}
//		break;
//		case "remove": fsr.removeFileSpec(filename);
//		break;
//		case "setTrim": 
