...
public class BaxterController {
    ...
    public void removeFile(Model model, Principal principal, @RequestParam("filepath") String filepath, @RequestParam("username") String username, @RequestParam(value = "code", required = false) String code) {
//        model.addAttribute("message", CodeRepo.getMessage(code));
